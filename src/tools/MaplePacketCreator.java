...
public class MaplePacketCreator {
    ...
    public static MaplePacket summonAttack(int cid, int summonSkillId, byte direction, int newStance, List<SummonAttackEntry> allDamage) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static MaplePacket updateBuddylist(Collection<BuddylistEntry> buddylist) {
        ...
        for (BuddylistEntry buddy : buddylist) {
            if (buddy.isVisible()) {
                ...
                //MapleCharacter chr = ChannelServer.getInstance(buddy.getChannel() - 1).getPlayerStorage().getCharacterById(buddy.getCharacterId());
                mplew.writeInt(0);//probably mapid :3
            }
        }
