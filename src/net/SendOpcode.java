...
public enum SendOpcode {
    ...
    TEMPORARY_SKILLS(0x23), //I THINK IT"S SKILLS f5
    UPDATE_SKILLS(0x24),
    FAME_RESPONSE(0x26),
    ...
    YELLOW_TIP(0x4D),
    PLAYER_NPC(0x51),
    MONSTERBOOK_ADD(0x52),
    MONSTER_BOOK_CHANGE_COVER(0x54),
    ENERGY(0xBD), //Yeah right f3
    SHOW_PEDIGREE(0x5E),
    OPEN_FAMILY(0x5F),
    FAMILY_MESSAGE(0x60),
    FAMILY_INVITE(0x61),
    ...
    FAMILY_USE_REQUEST(0x69),  //:O?
    BLANK_MESSAGE(0x6D), //:O?
    AVATAR_MEGA(0x6F),
    NAME_CHANGE_MESSAGE(0x71),
    UNKNOWN_MESSAGE(0x72),
    GM_POLICE(0x74),
    SILVER_BOX(0x75),
    ...
    SPOUSE_CHAT(0x88),
    BOSS_ENV(0x89),
    BLOCK_PORTAL(0x8A), //? WRONG?
    BLOCK_PORTAL_SHOP(0x8B), //? WRONG?
    MAP_EFFECT(0x8A),
    HPQ_MOON(0x8F),
    GM_PACKET(0x90),
    OX_QUIZ(0x91),
